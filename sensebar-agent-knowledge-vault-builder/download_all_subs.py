...
# Paths
urls_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), "sensebar_ai_urls.txt")
sub_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "subtitles")
