---
type: sca_theory
title: "肯亞 AA B - 醇厚果醬 | 金成淬"
date: 2026-05-18
tags: [coffee/sca_theory, imported/takeout]
---

# 📚 SCA 考官理論：肯亞 AA B - 醇厚果醬 | 金成淬
...
<head>
    ...
    <title>肯亞 AA 祈安喬古 (醇厚果醬) | 金成淬 · 淬成金</title>
            ...
            <div class="w-full max-w-md lg:w-1/2 p-2 relative">
                <div class="bg-white p-8 md:p-12 shadow-[0_15px_50px_-15px_rgba(0,0,0,0.05)] border border-gray-100 zen-border relative z-10">
                    <div class="flex items-center justify-between mb-8 pb-6 border-b border-gray-100">
                        <span class="text-xs tracking-[0.2em] text-refine-gold border border-refine-gold px-3 py-1.5">72hr 水洗 · 醇厚</span>
                        <span class="text-xs tracking-widest text-gray-400">Medium Roast</span>
                    </div>
                    
                    <h2 class="text-2xl md:text-3xl font-semibold text-ink-gray mb-3 tracking-wide leading-snug">肯亞 AA 涅里<br>祈安喬古</h2>
                    <p class="text-xs md:text-sm tracking-widest text-gray-400 mb-10 uppercase font-light">Kenya AA Nyeri - Rich Body</p>
                    ...
                    <div class="bg-zen-white p-6 space-y-4 border-l-2 border-refine-gold">
                        <p class="text-sm flex gap-5 items-center"><span class="text-refine-gold font-medium w-12 text-center text-xs tracking-widest">初韻</span> <span class="text-ink-gray tracking-wider">深邃莓果醬、烤堅果</span></p>
                        <p class="text-sm flex gap-5 items-center"><span class="text-refine-gold font-medium w-12 text-center text-xs tracking-widest">中調</span> <span class="text-ink-gray tracking-wider">濃郁黑糖、焦糖甘甜</span></p>
                        <p class="text-sm flex gap-5 items-center"><span class="text-refine-gold font-medium w-12 text-center text-xs tracking-widest">尾韻</span> <span class="text-ink-gray tracking-wider">厚實 Body、絲滑包覆</span></p>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full max-w-md lg:w-1/2 space-y-12 lg:pt-8">
                <div>
                    ...
                    <p class="text-gray-600 leading-[2.2] tracking-wide text-justify font-light text-[15px]">
                        畏懼酸味？請將味蕾交給這杯充滿重量感的肯亞。我們將酸質轉化為深邃的莓果醬，伴隨著濃郁的黑糖與焦糖甜感。醇厚的 Body 如絲綢般包覆口腔，帶來撫慰人心的溫暖力量。
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-6 text-[15px] text-gray-600 tracking-wider font-light leading-[1.8]">
                        <li class="flex items-start">
                            ...
                            <span><strong class="font-medium text-ink-gray tracking-widest">溫控萃取：</strong> <br>建議水溫 88-89°C。稍低的水溫能有效抑制酸值的釋放，放大甜感與厚實度。</span>
                        </li>
                        <li class="flex items-start">
                            <span class="text-refine-gold mr-4 mt-1.5 text-xs">◆</span>
                            <span><strong class="font-medium text-ink-gray tracking-widest">節奏流速：</strong> <br>建議稍粗研磨。適度拉長悶蒸與萃取時間，能完美榨取果醬般的醇厚與黑糖般的深沉甜感。</span>
                        </li>
                    </ul>
                </div>
            </div>
