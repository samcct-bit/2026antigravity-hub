---
type: sca_theory
title: "古吉藝伎 B - 奔放鮮活 | 金成淬"
date: 2026-05-18
tags: [coffee/sca_theory, imported/takeout]
---

# 📚 SCA 考官理論：古吉藝伎 B - 奔放鮮活 | 金成淬
...
<head>
    ...
    <title>衣索比亞 古吉 藝伎 (奔放鮮活) | 金成淬 · 淬成金</title>
    ...
    <script>
        tailwind.config = {
            theme: {
                extend: { colors: { 'zen-white': '#FAFAFA', 'ink-gray': '#2C2C2C', 'refine-gold': '#B8905B' }, fontFamily: { serif: ['"Noto Serif TC"', 'serif'] } }
            }
        }
    </script>
    <style>
            ...
            <div class="w-full max-w-md lg:w-1/2 p-2 relative">
                <div class="bg-white p-8 md:p-12 shadow-[0_15px_50px_-15px_rgba(0,0,0,0.05)] border border-gray-100 zen-border relative z-10">
                    <div class="flex items-center justify-between mb-8 pb-6 border-b border-gray-100">
                        <span class="text-xs tracking-[0.2em] text-refine-gold border border-refine-gold px-3 py-1.5">極致水洗 · 奔放</span>
                    ...
                    <p class="text-xs md:text-sm tracking-widest text-gray-400 mb-10 uppercase font-light">Guji Gelana Gesha - Vibrant</p>
                    ...
                    <div class="bg-zen-white p-6 space-y-4 border-l-2 border-refine-gold">
                        <p class="text-sm flex gap-5 items-center"><span class="text-refine-gold font-medium w-12 text-center text-xs tracking-widest">初韻</span> <span class="text-ink-gray tracking-wider">明亮檸檬酸、佛手柑香</span></p>
                        <p class="text-sm flex gap-5 items-center"><span class="text-refine-gold font-medium w-12 text-center text-xs tracking-widest">中調</span> <span class="text-ink-gray tracking-wider">白桃香氣、熱帶百香果</span></p>
                        <p class="text-sm flex gap-5 items-center"><span class="text-refine-gold font-medium w-12 text-center text-xs tracking-widest">尾韻</span> <span class="text-ink-gray tracking-wider">果汁般飽滿、層次分明</span></p>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full max-w-md lg:w-1/2 space-y-12 lg:pt-8">
                <div>
                    ...
                    <p class="text-gray-600 leading-[2.2] tracking-wide text-justify font-light text-[15px]">
                        獻給追求層次與明亮感的老饕。明亮的檸檬酸質劃破味蕾，隨之而來的是白桃與熱帶水果的狂歡。宛如一杯鮮榨的綜合果汁，層次分明，奔放而鮮活。每一次啜飲，都是果香的極致淬煉。
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-6 text-[15px] text-gray-600 tracking-wider font-light leading-[1.8]">
                        <li class="flex items-start">
                            ...
                            <span><strong class="font-medium text-ink-gray tracking-widest">溫控萃取：</strong> <br>建議水溫 92-93°C。稍微拉高水溫，以激發出最明亮、奔放的花香與高階果酸。</span>
                        </li>
                        <li class="flex items-start">
                            <span class="text-refine-gold mr-4 mt-1.5 text-xs">◆</span>
                            <span><strong class="font-medium text-ink-gray tracking-widest">節奏流速：</strong> <br>推薦使用較為輕快、不斷水的注水節奏，完美保留熱帶水果汁般的鮮活層次與乾淨度。</span>
                        </li>
                    </ul>
                </div>
            </div>
