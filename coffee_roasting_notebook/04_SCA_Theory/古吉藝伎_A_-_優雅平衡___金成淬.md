---
type: sca_theory
title: "古吉藝伎 A - 優雅平衡 | 金成淬"
date: 2026-05-18
tags: [coffee/sca_theory, imported/takeout]
---

# 📚 SCA 考官理論：古吉藝伎 A - 優雅平衡 | 金成淬
...
<head>
    ...
    <title>衣索比亞 古吉 藝伎 (優雅平衡) | 金成淬 · 淬成金</title>
            ...
            <div class="w-full max-w-md lg:w-1/2 p-2 relative">
                <div class="bg-white p-8 md:p-12 shadow-[0_15px_50px_-15px_rgba(0,0,0,0.05)] border border-gray-100 zen-border relative z-10">
                    <div class="flex items-center justify-between mb-8 pb-6 border-b border-gray-100">
                        <span class="text-xs tracking-[0.2em] text-refine-gold border border-refine-gold px-3 py-1.5">極致水洗 · 柔和</span>
                        <span class="text-xs tracking-widest text-gray-400">Light Roast</span>
                    </div>
                    
                    <h2 class="text-2xl md:text-3xl font-semibold text-ink-gray mb-3 tracking-wide leading-snug">衣索比亞 古吉<br>葛連娜 藝伎</h2>
                    <p class="text-xs md:text-sm tracking-widest text-gray-400 mb-10 uppercase font-light">Guji Gelana Gesha - Elegant</p>
                    ...
                    <div class="bg-zen-white p-6 space-y-4 border-l-2 border-refine-gold">
                        <p class="text-sm flex gap-5 items-center"><span class="text-refine-gold font-medium w-12 text-center text-xs tracking-widest">初韻</span> <span class="text-ink-gray tracking-wider">淡雅白花香、微風柑橘</span></p>
                        <p class="text-sm flex gap-5 items-center"><span class="text-refine-gold font-medium w-12 text-center text-xs tracking-widest">中調</span> <span class="text-ink-gray tracking-wider">蜜桃甜感、蜂蜜滑順</span></p>
                        <p class="text-sm flex gap-5 items-center"><span class="text-refine-gold font-medium w-12 text-center text-xs tracking-widest">尾韻</span> <span class="text-ink-gray tracking-wider">烏龍茶韻、甘甜優雅</span></p>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full max-w-md lg:w-1/2 space-y-12 lg:pt-8">
                <div>
                    ...
                    <p class="text-gray-600 leading-[2.2] tracking-wide text-justify font-light text-[15px]">
                        怕酸的你，也會愛上這杯藝伎的溫柔。白花香氣如晨露般綻放，沒有刺鼻的酸楚，只有蜜桃與蜂蜜交織的細緻甜感。尾段那抹悠長的烏龍茶韻，在舌尖輕柔收攏。這是一場尋求極致平衡的禪意之旅。
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-6 text-[15px] text-gray-600 tracking-wider font-light leading-[1.8]">
                        <li class="flex items-start">
                            ...
                            <span><strong class="font-medium text-ink-gray tracking-widest">溫控萃取：</strong> <br>建議水溫 90-92°C。溫和的水溫能有效收斂酸質，讓香氣柔和釋放。</span>
                        </li>
                        <li class="flex items-start">
                            <span class="text-refine-gold mr-4 mt-1.5 text-xs">◆</span>
                            <span><strong class="font-medium text-ink-gray tracking-widest">節奏流速：</strong> <br>適度拉長中後段的注水時間。較慢的流速有助於完美釋放蜂蜜的甜感與優雅的烏龍茶尾韻。</span>
                        </li>
                    </ul>
                </div>
            </div>
...
## 🔗 相關理論與對話推薦
- [[2026-02-24_沒有看到圖_1192]] (共用特徵: `藝伎, gesha, ror`)
- [[2026-02-27_請再告訴我Google_Apps_Script_整合後的完整系統代碼_操作步驟，包括開啟試算表後需要先建立哪些欄位和後續_1185]] (共用特徵: `藝伎, gesha, ror`)
- [[2026-02-27_請幫我生成一組理想的數據，例如_0,_0.5,_1..._分鐘對應的溫度，作為參考背景_1184]] (共用特徵: `藝伎, gesha, ror`)
- [[2026-03-26_請同時給我這一支豆子在同一台機器上詳細的烘焙計畫_800]] (共用特徵: `藝伎, gesha, ror`)
- [[2026-05-03_SCA_進階微型烘豆訓練簡報_340]] (共用特徵: `藝伎, gesha, ror`)
