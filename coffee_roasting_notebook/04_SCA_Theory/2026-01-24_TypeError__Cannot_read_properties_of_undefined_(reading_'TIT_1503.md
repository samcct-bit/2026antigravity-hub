---
type: sca_theory
title: "TypeError: Cannot read properties of und"
date: 2026-01-24
tags: [coffee/sca_theory, imported/takeout]
---

# 📚 SCA 考官理論：TypeError: Cannot read properties of undefined (reading 'TIT

## 📋 對話理論筆記
這是一個常見的引用錯誤。Google Apps Script 中用來定義版型的枚舉 (Enum) 名稱應該是 ** SlidesApp.PredefinedLayout **，而不是  SlidesApp.LayoutType 。

我已經修正了程式碼中的這兩處錯誤（分別在  addSlide  和  addCoverSlide  函式中）。請使用下方更新後的程式碼，這次應該可以順利執行了。
