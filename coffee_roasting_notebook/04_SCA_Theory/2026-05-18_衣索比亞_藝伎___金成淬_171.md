...
<head>
    ...
    <title>衣索比亞 古吉 葛連娜 藝伎 | 金成淬 · 淬成金</title>
            ...
            <div class="w-full max-w-md lg:w-1/2 p-2 relative">
                <div class="bg-white p-8 md:p-12 shadow-[0_15px_50px_-15px_rgba(0,0,0,0.05)] border border-gray-100 zen-border relative z-10">
                    <div class="flex items-center justify-between mb-8 pb-6 border-b border-gray-100">
                        <span class="text-xs tracking-[0.2em] text-refine-gold border border-refine-gold px-3 py-1.5">G1 頂級水洗</span>
                    ...
                    <p class="text-xs md:text-sm tracking-widest text-gray-400 mb-10 uppercase font-light">Ethiopia Guji Gelana Gesha</p>
                    ...
                    <div class="space-y-5 mb-12">
                        ...
                        <div class="flex justify-between items-center text-sm">
                            ...
                            <span class="text-ink-gray font-medium tracking-wider">Gesha</span>
                        </div>
                        <div class="w-full h-[1px] bg-gray-50"></div>
                        <div class="flex justify-between items-center text-sm">
                    ...
                    <div class="bg-zen-white p-6 space-y-4 border-l-2 border-refine-gold">
                        <p class="text-sm flex gap-5 items-center"><span class="text-refine-gold font-medium w-12 text-center text-xs tracking-widest">初韻</span> <span class="text-ink-gray tracking-wider">茉莉幽香繚繞、清透檸檬微光</span></p>
                        <p class="text-sm flex gap-5 items-center"><span class="text-refine-gold font-medium w-12 text-center text-xs tracking-widest">中調</span> <span class="text-ink-gray tracking-wider">白桃甘甜柔軟、荔枝飽滿多汁</span></p>
                        <p class="text-sm flex gap-5 items-center"><span class="text-refine-gold font-medium w-12 text-center text-xs tracking-widest">尾韻</span> <span class="text-ink-gray tracking-wider">絲滑茶感、高雅悠長</span></p>
                    </div>
                </div>
            </div>
                ...
                <div>
                    ...
                    <ul class="space-y-6 text-[15px] text-gray-600 tracking-wider font-light leading-[1.8]">
                        <li class="flex items-start">
                            ...
                            <span><strong class="font-medium text-ink-gray tracking-widest">溫控萃取：</strong> <br>建議水溫 90-91°C。適中水溫能完美保留細緻花香，避免過高溫破壞香氣或產生澀感。</span>
                        </li>
                        <li class="flex items-start">
                            <span class="text-refine-gold mr-4 mt-1.5 text-xs">◆</span>
                            <span><strong class="font-medium text-ink-gray tracking-widest">節奏流速：</strong> <br>建議採分段注水。前段以偏快流速帶出茉莉花香與明亮酸質，中後段放慢節奏，溫柔萃取白桃與荔枝的果汁甜感。</span>
                        </li>
                    </ul>
                </div>
            </div>
